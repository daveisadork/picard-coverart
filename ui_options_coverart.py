...
# Form implementation generated from reading ui file 'options_Coverart.ui'
#
...
class Ui_CoverartOptionsPage(object):
    def setupUi(self, CoverartOptionsPage):
        CoverartOptionsPage.setObjectName("CoverartOptionsPage")
        CoverartOptionsPage.resize(QtCore.QSize(QtCore.QRect(0,0,305,317).size()).expandedTo(CoverartOptionsPage.minimumSizeHint()))

        self.vboxlayout = QtGui.QVBoxLayout(CoverartOptionsPage)
        self.vboxlayout.setMargin(9)
        self.vboxlayout.setSpacing(6)
        self.vboxlayout.setObjectName("vboxlayout")

        self.rename_files = QtGui.QGroupBox(CoverartOptionsPage)
        ...
        self.rename_files_2 = QtGui.QGroupBox(CoverartOptionsPage)
        ...
        CoverartOptionsPage.setTabOrder(self.use_track_tags,self.ignore_tags)

    def retranslateUi(self, CoverartOptionsPage):
        self.rename_files.setTitle(_("Cover Art"))
